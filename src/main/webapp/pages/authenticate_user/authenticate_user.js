Application.$controller("authenticate_userPageController", ["$scope", function($scope) {
    "use strict";
    ...
    $scope.onPageReady = function() {
        ...
        $scope.Variables.statAppUsrid.dataSet.dataValue = $scope.Variables.loggedInUser.dataSet.name.toUpperCase();
